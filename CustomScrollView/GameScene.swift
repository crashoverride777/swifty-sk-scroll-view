...
class GameScene: SKScene {
    ...
    func prepareVerticalScrolling() {
        ...
        /// Test sprites page 1
        sprite1Page1 = SKSpriteNode(color: SKColor.red, size: CGSize(width: 50, height: 50))
    ...
    func prepareHorizontalScrolling() {
        ...
        /// Test sprites page 1
        sprite1Page1 = SKSpriteNode(color: SKColor.red, size: CGSize(width: 100, height: 100))
        sprite1Page1.position = CGPoint(x: 0, y: 0)
        page1ScrollView.addChild(sprite1Page1)
